    ...
    return queryInterface.bulkInsert('Questions', [
      {
        ...
        header: JSON.stringify({
          ...
          "Mengalami sakit fisik yang tidak dapar dijelaskan penyebabnya (sakit kepala, sakit punggung, sendi, perut, dll)": "number",
          ...
          "Mengalami masalah tidur yang memengaruhi kualitas tidur secara keseluruha.": "number",
