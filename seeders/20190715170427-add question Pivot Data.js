  ...
  up: (queryInterface, Sequelize) => {
    ...
    */
    ...
    return queryInterface.bulkInsert('tunnelQuestions', [
      ...
      { id: 5, tunnelId: 1, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: 18, tunnelId: 2, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: 31, tunnelId: 3, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: 42, tunnelId: 4, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: 52, tunnelId: 5, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: 64, tunnelId: 6, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: 70, tunnelId: 7, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: 80, tunnelId: 8, questionId: 33, createdAt: new Date(), updatedAt: new Date() },
    ], {});
